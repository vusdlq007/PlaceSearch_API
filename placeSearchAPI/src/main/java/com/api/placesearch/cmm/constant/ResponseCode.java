...
public enum ResponseCode {
    ...
    SEARCH_INFO_UPDATE_FAIL("KEYWORD INFO IS NOT EXIST OR INTER SERVER ERROR",505,"키워드 정보 업데이트에 실패하였습니다."),
    ...
    SEARCH_LOG_UPDATE_SUCCESS("SUCCESS",200,"로그 정보 업데이트에 성공하였습니다."),
    SEARCH_LOG_UPDATE_FAIL("INTER SERVER ERROR",505,"로그 정보 업데이트에 실패하였습니다."),
